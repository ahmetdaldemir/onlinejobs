...
export declare class AdminService {
    ...
    constructor(userRepository: Repository<User>, userInfoRepository: Repository<UserInfo>, jobRepository: Repository<Job>, messageRepository: Repository<Message>, categoryRepository: Repository<Category>);
